...
function parse2(str = "", format8 = "ms") {
  ...
  return result && result / (parse2.unit[format8] || 1) * (str[0] === "-" ? -1 : 1);
}
...
function from9({ name: name10, code: code10, encode: encode29 }) {
...
var parseTimeout = (value) => {
  return typeof value === "string" ? parse2(value) : value;
};
...
var Data = $root.Data = (() => {
      ...
      switch (t >>> 3) {
        ...
        case 4:
          ...
          if ((t & 7) === 2) {
            ...
            while (r.pos < c2)
              m2.blocksizes.push(r.uint64());
          } else
            m2.blocksizes.push(r.uint64());
          break;
        case 5:
          m2.hashType = r.uint64();
          break;
        case 6:
          m2.fanout = r.uint64();
          break;
        case 7:
          ...
          break;
        case 8:
          m2.mtime = $root.UnixTime.decode(r, r.uint32());
          break;
        default:
          r.skipType(t & 7);
          break;
  ...
  Data2.fromObject = function fromObject(d2) {
    ...
    if (d2.blocksizes) {
      ...
      m2.blocksizes = [];
      for (var i = 0; i < d2.blocksizes.length; ++i) {
        if ($util.Long)
          (m2.blocksizes[i] = $util.Long.fromValue(d2.blocksizes[i])).unsigned = true;
        else if (typeof d2.blocksizes[i] === "string")
          m2.blocksizes[i] = parseInt(d2.blocksizes[i], 10);
        else if (typeof d2.blocksizes[i] === "number")
          m2.blocksizes[i] = d2.blocksizes[i];
        else if (typeof d2.blocksizes[i] === "object")
          m2.blocksizes[i] = new $util.LongBits(d2.blocksizes[i].low >>> 0, d2.blocksizes[i].high >>> 0).toNumber(true);
      }
    }
    if (d2.hashType != null) {
      if ($util.Long)
  ...
  Data2.toObject = function toObject(m2, o) {
    if (!o)
      o = {};
    var d2 = {};
    ...
    if (o.defaults) {
      ...
      if ($util.Long) {
        ...
        d2.filesize = o.longs === String ? n.toString() : o.longs === Number ? n.toNumber() : n;
      } else
        d2.filesize = o.longs === String ? "0" : 0;
      if ($util.Long) {
        var n = new $util.Long(0, 0, true);
        d2.hashType = o.longs === String ? n.toString() : o.longs === Number ? n.toNumber() : n;
      } else
        d2.hashType = o.longs === String ? "0" : 0;
      if ($util.Long) {
        var n = new $util.Long(0, 0, true);
        d2.fanout = o.longs === String ? n.toString() : o.longs === Number ? n.toNumber() : n;
      } else
    ...
    if (m2.blocksizes && m2.blocksizes.length) {
      ...
      for (var j = 0; j < m2.blocksizes.length; ++j) {
        if (typeof m2.blocksizes[j] === "number")
          d2.blocksizes[j] = o.longs === String ? String(m2.blocksizes[j]) : m2.blocksizes[j];
        else
          d2.blocksizes[j] = o.longs === String ? $util.Long.prototype.toString.call(m2.blocksizes[j]) : o.longs === Number ? new $util.LongBits(m2.blocksizes[j].low >>> 0, m2.blocksizes[j].high >>> 0).toNumber(true) : m2.blocksizes[j];
      }
    }
...
var UnixTime = $root.UnixTime = (() => {
  ...
  UnixTime2.encode = function encode29(m2, w) {
    if (!w)
      w = $Writer.create();
    w.uint32(8).int64(m2.Seconds);
    if (m2.FractionalNanoseconds != null && Object.hasOwnProperty.call(m2, "FractionalNanoseconds"))
      w.uint32(21).fixed32(m2.FractionalNanoseconds);
    return w;
  };
  UnixTime2.decode = function decode39(r, l) {
    if (!(r instanceof $Reader))
      r = $Reader.create(r);
    var c = l === void 0 ? r.len : r.pos + l, m2 = new $root.UnixTime();
    while (r.pos < c) {
      var t = r.uint32();
      switch (t >>> 3) {
        case 1:
          ...
          break;
        case 2:
          m2.FractionalNanoseconds = r.fixed32();
          break;
        default:
          r.skipType(t & 7);
          break;
  ...
  UnixTime2.toObject = function toObject(m2, o) {
    if (!o)
      o = {};
    var d2 = {};
    if (o.defaults) {
      if ($util.Long) {
        ...
        d2.Seconds = o.longs === String ? n.toString() : o.longs === Number ? n.toNumber() : n;
      } else
...
var Metadata = $root.Metadata = (() => {
  ...
  Metadata2.encode = function encode29(m2, w) {
    if (!w)
      w = $Writer.create();
    if (m2.MimeType != null && Object.hasOwnProperty.call(m2, "MimeType"))
      w.uint32(10).string(m2.MimeType);
    return w;
  };
  Metadata2.decode = function decode39(r, l) {
    if (!(r instanceof $Reader))
      r = $Reader.create(r);
    var c = l === void 0 ? r.len : r.pos + l, m2 = new $root.Metadata();
    while (r.pos < c) {
      var t = r.uint32();
      switch (t >>> 3) {
        case 1:
          m2.MimeType = r.string();
          break;
        default:
          r.skipType(t & 7);
          break;
  ...
  Metadata2.toObject = function toObject(m2, o) {
    if (!o)
      o = {};
    var d2 = {};
    if (o.defaults) {
